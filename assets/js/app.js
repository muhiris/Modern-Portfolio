...
// Scroll Bar Hide
let mainBtn = document.querySelector(".intro-btn");
...
function cursor(e) {
  mouseCursor.style.transition = "top 0.1s, left 0.1s"; // Add a short transition for smooth movement
...
//GSAP animations
function fadeOut() {
  TweenMax.to(".intro-btn, .textIn", 1, {
    opacity: 0,
    y: -100,
  });
  TweenMax.to(".text", 1, {
